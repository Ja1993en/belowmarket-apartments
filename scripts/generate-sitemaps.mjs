...
const coreRoutes = [
  ...
  { path: "/dallas-luxury-apartments-specials", priority: "0.86", changefreq: "weekly" },
  { path: "/dallas-apartments-with-move-in-specials", priority: "0.86", changefreq: "weekly" },
  { path: "/dallas-apartments-waived-admin-fee", priority: "0.84", changefreq: "weekly" },
  { path: "/las-colinas-apartments-specials", priority: "0.84", changefreq: "weekly" },
  { path: "/farmers-branch-apartments-6-weeks-free", priority: "0.84", changefreq: "weekly" },
  { path: "/uptown-dallas-apartments-4-weeks-free", priority: "0.84", changefreq: "weekly" },
  { path: "/medical-district-apartments-specials", priority: "0.84", changefreq: "weekly" },
  { path: "/turtle-creek-apartments-specials", priority: "0.84", changefreq: "weekly" },
  { path: "/farmers-branch-apartments-8-weeks-free", priority: "0.84", changefreq: "weekly" },
  { path: "/west-dallas-apartments-specials", priority: "0.82", changefreq: "weekly" },
  { path: "/deep-ellum-apartments-specials", priority: "0.82", changefreq: "weekly" },
  { path: "/north-dallas-apartments-specials", priority: "0.82", changefreq: "weekly" },
